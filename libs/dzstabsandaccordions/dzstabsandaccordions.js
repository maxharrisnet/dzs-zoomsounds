...
if(window.jQuery==undefined){
    alert("dzstabsandaccordions.js -> jQuery is not defined or improperly declared ( must be included at the start of the head tag ), you need jQuery for this plugin");
}
