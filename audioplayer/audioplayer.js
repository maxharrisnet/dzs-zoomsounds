    ...
    $.fn.audioplayer = function(o) {
        ...
        this.each(function() {
            ...
            function setup_structure(pargs) {
                ...
                // console.info('o.controls_external_scrubbar - ',o.controls_external_scrubbar);
                if(o.controls_external_scrubbar){
...
//                            console.info(auxa);
            ...
            function init_loaded(pargs) {
                ...
                setTimeout(function() {
                    ...
                    // console.info('audioCtx_buffer.duration - ',audioCtx_buffer.duration)
                    // console.info('_cmedia.duration - ',_cmedia.duration)
                    ...
                    if (o.skinwave_enableSpectrum == 'on') {
                        ...
                        var drawMeter = function() {
                            ...
                            if(debug_var){
                                ...
                                // console.info('sw_spectrum_fakeit - ',sw_spectrum_fakeit);
                                // console.info(lastarray);
            ...
            function draw_scrub_prog(){
                ...
                // if(debug_var2){
                //     console.info('spos - ',spos,'time_total - ',time_total,cthis,'audioCtx_buffer - ',audioCtx_buffer,'_scrubbar - ', _scrubbar, '_scrubbar.children(\'.scrub-prog\') - > ',_scrubbar.children('.scrub-prog'));
                //     // debug_var2 = false;
                // }
            ...
            function get_times(pargs){
                ...
                // console.info('get_times () margs - ',margs,'type - ',type,o.type);
                // -- trying to get current time
                if ( (type == 'audio' || ( type=='fake' && o.fakeplayer)) ) {
                    if (o.type != 'shoutcast') {

                        // console.info('check - (audioCtx_buffer && audioCtx_buffer != \'placeholder\' && audioCtx_buffer != \'waiting\') -> ',(audioCtx_buffer && audioCtx_buffer != 'placeholder' && audioCtx_buffer != 'waiting'),audioCtx_buffer);
                        ...
                        if (audioCtx_buffer && audioCtx_buffer != 'placeholder' && audioCtx_buffer != 'waiting') {
                            ...
                            // console.info('time_total_for_real - ',time_total_for_real);
                ...
                // console.info('time_total_for_real -5 ',time_total_for_real);
            }
            ...
            function click_playpause(e) {
                ...
                // console.info('time_total_for_visual -7 ',time_total_for_visual);
                ...
                if (o.design_skin == 'skin-wave') {
                    ...
                    if (_commentsHolder) {
                        ...
                        if(_scrubbar && cthis && _scrubbar.offset()){
                            _scrubbar.offset().left - cthis.offset().left;
                        }else{
                            console.info('no scrubbar or cthis',_scrubbar, cthis);
                        }
